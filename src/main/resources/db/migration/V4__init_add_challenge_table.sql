...
INSERT INTO challenges (title, description, earned_points, created_at) VALUES
  ('Ăn 2 lá rau', 'Hoàn thành việc ăn 2 lá rau xanh.', 15, CURRENT_TIMESTAMP),
  ('Ăn canh', 'Hoàn thành bát canh trong bữa ăn.', 20, CURRENT_TIMESTAMP),
  ('Đi ngủ trưa', 'Đi ngủ trưa đúng giờ và đủ giấc.', 25, CURRENT_TIMESTAMP),
  ('Đọc 1 trang sách', 'Đọc hết 1 trang sách bất kỳ.', 10, CURRENT_TIMESTAMP),
  ('Đọc 2 trang sách', 'Đọc liền 2 trang sách mà không dừng lại.', 20, CURRENT_TIMESTAMP),
...
INSERT INTO challenges (title, description, earned_points, created_at) VALUES
  ...
  ('Tự tắm', 'Tự tắm sạch sẽ mà không cần nhắc nhở.', 30, CURRENT_TIMESTAMP),
  ('Tự gội đầu', 'Tự gội đầu sạch sẽ mà không cần hỗ trợ.', 35, CURRENT_TIMESTAMP);
...
INSERT INTO challenges (title, description, earned_points, created_at) VALUES
  ...
  ('Học bài đầy đủ', 'Hoàn thành tất cả bài tập về nhà đúng hạn.', 60, CURRENT_TIMESTAMP),
  ...
  ('Học thuộc lòng một bài thơ', 'Thuộc lòng và đọc trôi chảy một bài thơ.', 55, CURRENT_TIMESTAMP);
